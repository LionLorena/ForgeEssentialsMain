...
public class FELocalWorld extends LocalWorld {
	...
	public boolean copyFromWorld(Vector arg0, BaseBlock arg1) {
		...
		if (arg1 instanceof FurnaceBlock) {
			...
			we.setItems(Util.inventoryToBaseItemStack(furnace));
			return true;
		}
		...
		if (arg1 instanceof ContainerBlock) {
			...
			((ContainerBlock)arg1).setItems(Util.inventoryToBaseItemStack((IInventory)te));
			return true;
		}
	...
	public boolean copyToWorld(Vector arg0, BaseBlock arg1) {
		...
		if (arg1 instanceof FurnaceBlock) {
			...
			Util.baseItemStackToInventory(we.getItems(), furnace);
			return true;
		}
		...
		if (arg1 instanceof ContainerBlock) {
			...
			Util.baseItemStackToInventory(((ContainerBlock)arg1).getItems(), (IInventory)te);
			return true;
		}
	...
	public void dropItem(Vector arg0, BaseItemStack arg1) {
		world.spawnEntityInWorld(new EntityItem(world, arg0.getX(), arg0.getY(), arg0.getZ(), Util.baseItemStackToStack(arg1)));
	}
	...
	public BiomeType getBiome(Vector2D arg0) {
		try {
			return ModuleWECompat.instance.serverInterface.getBiomes().get(world.getBiomeGenForCoords(arg0.getBlockX(), arg0.getBlockZ()).biomeName);
		} catch (Throwable e) {
			e.printStackTrace();
		}
	...
	public int removeEntities(EntityType arg0, Vector arg1, int arg2) {
		...
		for (Entity ent : (List<Entity>)world.getEntitiesWithinAABB(Util.getEntityType(arg0), AxisAlignedBB.getBoundingBox(arg1.getX() - arg2, arg1.getY() - arg2, arg1.getZ() - arg2, arg1.getX() + arg2, arg1.getY() + arg2, arg1.getZ() + arg2))) {
			ent.setDead();
			count++;
		}
	...
	public LocalEntity[] getEntities(Region arg0) {
		...
		for (Entity entity : (List<Entity>)world.getEntitiesWithinAABB(Entity.class, AxisAlignedBB.getBoundingBox(min.getX(), min.getY(), min.getZ(), max.getX(), max.getY(), max.getZ()))) {
			ret.add(ModuleWECompat.instance.getEntity(entity));
		}
